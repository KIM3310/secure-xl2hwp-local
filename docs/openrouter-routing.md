...
| Lane | Model | Purpose |
|---|---|---|
| Primary | `qwen/qwen3-next-80b-a3b-thinking` | Local-first document cleanup reasoning with explicit opt-in for hosted inference. |
...
OPENROUTER_HTTP_REFERER=https://secure-xl2hwp-local.pages.dev
OPENROUTER_APP_TITLE=secure-xl2hwp-local
```
