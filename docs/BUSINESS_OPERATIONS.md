...
- Review 30 redacted secret-pattern finding(s) from the audit index before publishing or deploying.
...
- Redacted audit has 30 possible secret-pattern finding(s); manually review before publication or deploy.
