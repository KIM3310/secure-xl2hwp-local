# Service Growth Model - secure-xl2hwp-local
...
| Field | Decision |
|---|---|
| Service type | Local-first Korean document automation |
| Primary reader or buyer | Korean teams needing controlled document conversion and audit exports. |
| Wedge | Template compatibility review and local install validation. |
